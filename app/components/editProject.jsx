    ...
    try {
      ...
      if (projectForm?.name && projectForm?.owner && projectForm?._id) {
        const response = await postAPI(
          `${domain}/api/project/updateproject`,
        ...
        <div className="add-pro-content">
          ...
          <div className="section">
            ...
            <div>
              ...
              >
                <option value={projectForm?.project_access}>
                  {projectForm?.project_access}
                </option>
          ...
          <p>Description:</p>
          <Editor
            style={{ height: "320px", border: "1px solid #F92E2E" }}
            onTextChange={(e) =>
              setProjectForm((prev) => {
          ...
          <div className="btn">
            <button className="addbtn" onClick={() => updateProject()}>
              Update
            </button>
            <button
              className="cancelbtn"
